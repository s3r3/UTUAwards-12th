  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (!json.success) throw new Error(t.products.loadFailed)
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
          {t.wishlist.title.replace('{count}', String(products.length))}
        </h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">{t.member.wishlistEmpty}</h3>
