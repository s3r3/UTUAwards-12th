      ...
      <section className="pt-28 pb-20 gradient-hero">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Hubungi <span className="bg-gradient-to-r from-primary-600 to-ocean-600 bg-clip-text text-transparent">Kami</span>
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Punya pertanyaan atau ingin bermitra? Tim kami siap membantu Anda.
          </p>
        </div>
      </section>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8">
              {sent ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Tim kami akan segera menghubungi Anda.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Kirim Pesan</h2>
