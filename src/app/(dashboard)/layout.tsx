...
import { LayoutDashboard, ShoppingBag, User, Settings, Shield, Package, Users, Menu, X, LogOut, Sun, Moon } from 'lucide-react'
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`min-h-screen flex ${isDark ? 'bg-gray-950 text-gray-200' : 'bg-gray-50 text-gray-700'}`}>
      {/* Overlay for mobile */}
