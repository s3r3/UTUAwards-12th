...
export default function PartnerLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
      <main className="grid min-h-screen place-items-center bg-cream p-6 dark:bg-gray-950">
        <div className="max-w-sm text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Halaman ini hanya tersedia untuk mitra ACELORA.</p>
        </div>
      </main>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-cream text-gray-700 dark:bg-gray-950 dark:text-gray-200">
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 w-72 border-r border-gray-200 transition-transform dark:border-gray-800 md:translate-x-0 ${open ? 'translate-x-0' : '-translate-x-full'}`}>
      ...
      <div className="min-w-0 md:ml-72">
        <PartnerHeader onMenu={() => setOpen(true)} />
