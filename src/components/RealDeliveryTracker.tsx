      ...
      {showTracking && (
        <div className="relative my-6 border border-black/15 rounded-xl overflow-hidden bg-stone-100 dark:bg-gray-900">
          <MapContainer
            ...
            ref={(m) => {
              mapRef.current = m
              if (m) m.fitBounds(bounds.pad(0.25))
            }}
          ...
          >
            ...
            {/* Vehicle marker — positioned via Leaflet for map-accurate coords */}
            ...
            <div className="flex items-center gap-2 mb-2">
              <div
                className={`w-3 h-3 rounded-full ${
                  progress >= 1 ? 'bg-emerald-600' : progress >= 0.6 ? 'bg-purple-600' : progress >= 0.25 ? 'bg-blue-600' : 'bg-amber-600'
                } animate-pulse`}
              />
