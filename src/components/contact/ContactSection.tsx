...
export default function ContactSection() {
  ...
  const contactInfo = [
    { label: t.landing.contactInquiries, value: 'hello@acelora.com' },
    { label: t.landing.contactPartnerships, value: 'partner@acelora.com' },
    { label: t.landing.contactOffice, value: 'Jl. Raya Aceh, Banda Aceh, Indonesia.' },
  ]

  const fields = [
    { name: 'name', placeholder: t.auth.name, type: 'text' },
    ...
    <section className="mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-12">
      ...
      <motion.div variants={stagger} initial="hidden" animate="visible" className="grid grid-cols-1 md:grid-cols-2 md:divide-x md:divide-slate-950/10 dark:md:divide-white/10">
        ...
        >
          ...
          <div className="group">
            <label htmlFor="subject" className="sr-only">{t.landing.selectSubject}</label>
            <select
              id="subject"
              name="subject"
